...
import { searchQuery, cleanupHighlight, highlightMatchedNodes } from "../utils/graph/search";
...
export const useFocusNode = () => {
  ...
  React.useEffect(() => {
    ...
    const matchedNodes = searchQuery(`span[data-key*='${debouncedValue}' i]`);
  ...
  return [value, setValue, skip, nodeCount, selectedNode];
};
